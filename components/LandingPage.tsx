...
export default function LandingPage() {
    ...
    const signInWith = async (strategy: "oauth_google" | "oauth_github") => {
        try {
            ...
            const result: any = await signIn?.authenticateWithRedirect({
                strategy,
            ...
            if (result?.status === 'complete' && result.createdUserId) {
                ...
                // Returning user, direct them to dashboard or appropriate page
  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-12 text-center">
              ...
              <div className="w-full max-w-sm space-y-2 mt-10   ">
                ...
                <Button className="w-full" variant="outline" onClick={() => signInWith("oauth_google")}>
                  <svg
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground">© 2023 CryptoWallet. All rights reserved.</p>
